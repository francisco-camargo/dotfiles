...
The [uv gate](#the-uv-gate) refuses a bare `python` and tells Claude to run `uv` instead, and the [commit gates](docs/security.md#the-commit-gates) need `pre-commit`.
